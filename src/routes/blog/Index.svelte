...
<main class="flex flex-col items-center sm:mx-16 lg:mx-32 pt-16">
  {#each QUERYRES.posts as post}
    <a href="/blog/{post.slug}/" class="flex flex-row rounded-lg w-full mb-8 border-gray-300 border-2 ">
      <div
        class="flex flex-col items-start justify-center py-6 px-8 card
        ...
        <div class="flex flex-wrap flex-row mr-auto mt-1 w-full">
      ...
      <img
        ...
        alt="Preview"
        class="text-white font-semibold rounded-r-lg w-1/4 object-scale-down object-center pr-8" />
    </a>
  {/each}
